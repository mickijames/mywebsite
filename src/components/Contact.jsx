        ...
        return (
            <div id='contact' className="page-height section fp-auto-height">
                <Segment padded="very" className="text">
                    ...
                    <p>Here's my <a href="https://docs.google.com/document/d/1BApRMs2futAOme9hKF-AN3AJfxGh4j98dF3zp4C6Re8/edit?usp=sharing" target="_blank" rel="noopener noreferrer">Resume</a> if you're interested.</p>
                </Segment>
            </div>
        );
    }
